...
public class LogicalExpressionParser {
     ...
     * @return 逻辑表达式
     */
    public static Expression parse(String input, Map<String, Predicate<ExpressionFacts>> predicateMap) {
     ...
     * @return 逻辑表达式
     */
    public static Expression parseExpression(List<String> tokens, Map<String, Predicate<ExpressionFacts>> predicateMap) {
